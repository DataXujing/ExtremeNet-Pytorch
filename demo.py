...
# from dextr import Dextr   # no segment
...
def parse_args():
    ...
    parser.add_argument("--model_path",
                        default='cache/nnet/ExtremeNet/ExtremeNet_50000.pkl')
...
if __name__ == "__main__":
    ...
    for image_id, image_name in enumerate(image_names):
        ...
        if 1: # visualize
            ...
            for j in range(1, categories + 1):
                ...
                for bbox in top_bboxes[image_id][j][keep_inds]:
                    ...
                    image = vis_class(image, 
                                      (bbox[0], bbox[1] - 2), txt, font_scale=0.6)
                    image = vis_octagon(
                        image, ex, color_mask)
            ...
            cv2.imwrite("./images/result/"+image_name.split("/")[-1],image)
            print("[INFO] {} 完成识别")
